...
{
    public partial class DataKategoriBarang : MetroForm
    {
        ...
        private void kode()
        {
            ...
            {
                cmd = new MySqlCommand("select kode from kategori where kode in(select max(kode) from kategori) order by kode desc", conn);
                ...
                if (rd.HasRows)
                {
                    ...
                    urut = "CAT" + joinstr.Substring(joinstr.Length - 3, 3);
                }
                else
                {
                    urut = "CAT001";
        ...
        public void Insert()
        {
            string query = "INSERT INTO kategori VALUES(@kode, @nama)";
            ...
            if (this.OpenConnection() == true)
            {
                ...
                if (result == 1)
                {
                    MetroMessageBox.Show(this, "Input Data Kategori Success!", "Success!", MessageBoxButtons.OK, MessageBoxIcon.Question);
                }
                else
                {
                    MetroMessageBox.Show(this, "Input Data Kategori Gagal!", "Gagal!", MessageBoxButtons.OK, MessageBoxIcon.Stop);
        ...
        {
            string query = "UPDATE kategori SET nama = @nama WHERE kode = @kode";
            ...
            if (this.OpenConnection() == true)
            {
                ...
                if (result == 1)
                {
                    MetroMessageBox.Show(this, "Update Data Kategori Success!", "Success!", MessageBoxButtons.OK, MessageBoxIcon.Question);
                }
                else
                {
                    MetroMessageBox.Show(this, "Update Data Kategori Gagal!", "Gagal!", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                }
            }
        ...
        public void Delete()
        {
            string query = "DELETE FROM kategori WHERE kode = @kode";
            ...
            if (this.OpenConnection() == true)
            {
                ...
                if (result == 1)
                {
                    MetroMessageBox.Show(this, "Delete Data Kategori Success!", "Success!", MessageBoxButtons.OK, MessageBoxIcon.Question);
                }
                else
                {
                    MetroMessageBox.Show(this, "Delete Data Kategori Gagal!", "Gagal!", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                }
            }
            //close connection
            this.CloseConnection();
